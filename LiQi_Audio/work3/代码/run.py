...
parser.add_argument('--batch_size', type=int, default=300, metavar='N', help='training and valid batch size')
...
if __name__ == '__main__':
    ...
    while (epoch < args.epochs + 1) and (iteration < args.patience):
        ...
        valid_loss = test(valid_loader, model, args.cuda, Accuracy_list)
